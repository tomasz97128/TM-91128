...
Z punktu widzenia bezpieczeństwa, najpoważniejszym problemem jest flaga `debuggable`. Pozwala ona na użycie komendy `adb jdwp` do śledzenia procesów aplikacji przez osoby niepowołane. Jest to bardzo wartościowa informacja.
